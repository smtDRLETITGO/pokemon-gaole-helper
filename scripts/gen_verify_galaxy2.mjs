// gen_verify_galaxy2.mjs — 產生銀河第二彈（已 live）73 張卡視覺化驗證頁
...
<h1>銀河第二彈 (cassette/11) · 73 張卡驗證</h1>
<div class="sub">資料來源：本頁由 scripts/gen_galaxy2.mjs 從 scripts/galaxy2.ground_truth.json（掃描圖萃取真值）重新生成，已 live。星等 = 背面圖 ★ 人工逐一目視確認 (2026-07-17, 73/73)；招式/屬性 = 背面圖 VLM 讀取 + 玩家參考表驗證；六維 = easyocr 100% OCR。D=物理 / X=特殊。舊 DB 自動初值已廢棄。</div>
<div class="stats">
  <div class="box"><div class="n">${C.length}</div><div class="l">總卡數</div></div>
  ...
  <div class="box"><div class="n">${dual} / ${C.length-dual}</div><div class="l">雙屬性 / 單屬性</div></div>
...
writeFileSync(resolve(ROOT, 'verify_galaxy2.html'), html, 'utf-8');
console.log('→ verify_galaxy2.html written ('+C.length+' cards)');
